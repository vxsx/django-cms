...
"function"!=typeof Array.prototype.findIndex&&(Array.prototype.findIndex=function(r){if(null===this)throw new TypeError("Array.prototype.findIndex called on null or undefined");if("function"!=typeof r)throw new TypeError("predicate must be a function");for(var n,e=Object(this),t=e.length>>>0,o=arguments[1],f=0;t>f;f++)if(n=e[f],r.call(o,n,f,e))return f;return-1});
...
var CMS=window.CMS||{};!function(i){"use strict";CMS.Modal=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,closeOnEsc:!0,minHeight:400,minWidth:800,modalDuration:200,resizable:!0,maximizable:!0,minimizable:!0},initialize:function(t){this.options=i.extend(!0,{},this.options,t),this._setupUI(),this._setupEventEmitter(),this.click="click.cms.modal",this.pointerDown="pointerdown.cms.modal contextmenu.cms.modal",this.pointerUp="pointerup.cms.modal pointercancel.cms.modal",this.pointerMove="pointermove.cms.modal",this.doubleClick="dblclick.cms.modal",this.touchEnd="touchend.cms.modal",this.maximized=!1,this.minimized=!1,this.triggerMaximized=!1,this.saved=!1},_setupEventEmitter:function(){function t(i){return function(){return o[i].apply(o,arguments),e}}var e=this,o=i({});this.trigger=t("trigger"),this.one=t("one"),this.on=t("on"),this.off=t("off")},_setupUI:function(){var t=i(".cms-modal");this.ui={modal:t,body:i("html"),window:i(window),toolbarLeftPart:i(".cms-toolbar-left"),minimizeButton:t.find(".cms-modal-minimize"),maximizeButton:t.find(".cms-modal-maximize"),title:t.find(".cms-modal-title"),titlePrefix:t.find(".cms-modal-title-prefix"),titleSuffix:t.find(".cms-modal-title-suffix"),resize:t.find(".cms-modal-resize"),breadcrumb:t.find(".cms-modal-breadcrumb"),closeAndCancel:t.find(".cms-modal-close, .cms-modal-cancel"),modalButtons:t.find(".cms-modal-buttons"),modalBody:t.find(".cms-modal-body"),frame:t.find(".cms-modal-frame"),shim:t.find(".cms-modal-shim")}},_events:function(){var t=this;this.ui.minimizeButton.off(this.click+" "+this.touchEnd).on(this.click+" "+this.touchEnd,function(i){i.preventDefault(),t.minimize()}),this.ui.maximizeButton.off(this.click+" "+this.touchEnd).on(this.click+" "+this.touchEnd,function(i){i.preventDefault(),t.maximize()}),this.ui.title.off(this.pointerDown).on(this.pointerDown,function(i){i.preventDefault(),t._startMove(i)}),this.ui.title.off(this.doubleClick).on(this.doubleClick,function(){t.maximize()}),this.ui.resize.off(this.pointerDown).on(this.pointerDown,function(i){i.preventDefault(),t._startResize(i)}),this.ui.closeAndCancel.off(this.click+" "+this.touchEnd).on(this.click+" "+this.touchEnd,function(i){i.preventDefault(),t._cancelHandler()}),this.ui.breadcrumb.off(this.click,"a").on(this.click,"a",function(e){e.preventDefault(),t._changeIframe(i(this))})},open:function(t){if(!(t&&t.url||t&&t.html))throw new Error('The arguments passed to "open" were invalid.');this._events(),this.trigger("cms.modal.load"),this.ui.modal.trigger("cms.modal.load"),this.ui.resize.toggle(this.options.resizable),this.ui.minimizeButton.toggle(this.options.minimizable),this.ui.maximizeButton.toggle(this.options.maximizable);var e=this._calculateNewPosition(t);return this.ui.maximizeButton.removeClass("cms-modal-maximize-active"),this.maximized=!1,this.ui.body.hasClass("cms-modal-minimized")&&(this.minimized=!0,this.minimize()),this.ui.modalButtons.empty(),this.ui.breadcrumb.empty(),this.ui.modal.removeClass("cms-modal-has-breadcrumb"),CMS.API.Tooltip.hide(),t.url?this._loadIframe({url:t.url,title:t.title,breadcrumbs:t.breadcrumbs}):this._loadMarkup({html:t.html,title:t.title,subtitle:t.subtitle}),this.trigger("cms.modal.loaded"),this._show(i.extend({duration:this.options.modalDuration},e)),this},_calculateNewPosition:function(i){var t,e,o=300,s=300,n=this.ui.window.width(),a=this.ui.window.height(),d=i.width||this.options.minWidth,m=i.height||this.options.minHeight,l=n>=d+o,r=a>=m+s,c=l&&!i.width?n-o:d,h=r&&!i.height?a-s:m,u=this.ui.modal.css("left"),f=this.ui.modal.css("top");return"50%"===u&&(u=n/2),"50%"===f&&(f=a/2),f=parseInt(f,10),u=parseInt(u,10),(c/2+u>n||h/2+f>a||0>u-c/2||0>f-h/2)&&(t=n/2,e=a/2),(c>=n||h>=a)&&(this.triggerMaximized=!0),{width:c,height:h,top:e,left:t}},_show:function(i){var t=this,e=i.width,o=i.height,s=i.duration,n=i.top,a=i.left;this.ui.modal.hasClass("cms-modal-open")&&this.ui.modal.addClass("cms-modal-morphing"),this.ui.modal.css({display:"block",width:e,height:o,top:n,left:a,"margin-left":-(e/2),"margin-top":-(o/2)}),setTimeout(function(){t.ui.modal.addClass("cms-modal-open")},0),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.removeClass("cms-modal-morphing"),t.ui.modal.css({"margin-left":-(e/2),"margin-top":-(o/2)}),t.triggerMaximized&&t.maximize(),CMS.API.locked=!1,t.trigger("cms.modal.shown")}).emulateTransitionEnd(s),this.ui.body.off("keydown.cms.close").on("keydown.cms.close",function(i){i.keyCode===CMS.KEYS.ESC&&t.options.closeOnEsc&&t._cancelHandler()}),this.ui.modal.focus()},close:function(){var i=CMS.API.Helpers.dispatchEvent("modal-close",{instance:this});return i.isDefaultPrevented()?!1:(this.options.onClose&&this.reloadBrowser(this.options.onClose,!1,!0),void this._hide({duration:this.options.modalDuration/2}))},_hide:function(i){var t=this,e=this.options.modalDuration;i&&i.duration&&(e=i.duration),this.ui.frame.empty(),this.ui.modalBody.removeClass("cms-loader"),this.ui.modal.removeClass("cms-modal-open"),this.ui.modal.one("cmsTransitionEnd",function(){t.ui.modal.css("display","none")}).emulateTransitionEnd(e),setTimeout(function(){t.minimized&&t.minimize(),t.maximized&&t.maximize(),t.trigger("cms.modal.closed"),CMS.API.Toolbar.hideLoader(),CMS.API.Helpers.dispatchEvent("modal-closed",{instance:t})},this.options.duration),this.ui.body.off("keydown.cms.close")},minimize:function(){var i=50;return this.maximized?!1:void(this.minimized===!1?(CMS.API.Toolbar.open(),this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top"])),this.ui.body.addClass("cms-modal-minimized"),this.ui.modal.css({left:this.ui.toolbarLeftPart.outerWidth(!0)+i}),this.minimized=!0):(this.ui.body.removeClass("cms-modal-minimized"),this.ui.modal.css(this.ui.modal.data("css")),this.minimized=!1))},maximize:function(){return this.minimized?!1:void(this.maximized===!1?(this.ui.modal.data("css",this.ui.modal.css(["left","top","margin-left","margin-top","width","height"])),this.ui.body.addClass("cms-modal-maximized"),this.maximized=!0,this.dispatchEvent("modal-maximized",{instance:this})):(this.ui.body.removeClass("cms-modal-maximized"),this.ui.modal.css(this.ui.modal.data("css")),this.maximized=!1,this.dispatchEvent("modal-restored",{instance:this})))},_startMove:function(i){if(this.maximized||this.minimized)return!1;var t,e,o=this,s=this.ui.modal.position();this.ui.shim.show(),this.ui.body.on(this.pointerUp,function(i){o._stopMove(i)}),this.ui.body.on(this.pointerMove,function(n){t=s.left-(i.originalEvent.pageX-n.originalEvent.pageX),e=s.top-(i.originalEvent.pageY-n.originalEvent.pageY),o.ui.modal.css({left:t,top:e})}).attr("data-touch-action","none")},_stopMove:function(){this.ui.shim.hide(),this.ui.body.off(this.pointerMove+" "+this.pointerUp).removeAttr("data-touch-action")},_startResize:function(i){if(this.maximized)return!1;var t=this,e=this.ui.modal.width(),o=this.ui.modal.height(),s=this.ui.modal.position().left,n=this.ui.modal.position().top;this.ui.body.on(this.pointerUp,function(i){t._stopResize(i)}),this.ui.shim.show(),this.ui.body.on(this.pointerMove,function(a){var d=i.originalEvent.pageX-a.originalEvent.pageX,m=i.originalEvent.pageY-a.originalEvent.pageY,l=e-2*d,r=o-2*m,c=t.options.minWidth,h=t.options.minHeight,u=d+s,f=m+n;c>=l&&(l=c,u=s+e/2-l/2),h>=r&&(r=h,f=n+o/2-r/2),t.ui.modal.css({width:l,height:r,left:u,top:f})}).attr("data-touch-action","none")},_stopResize:function(){this.ui.shim.hide(),this.ui.body.off(this.pointerMove+" "+this.pointerUp).removeAttr("data-touch-action")},_setBreadcrumb:function(t){var e="",o='<a href="{1}" class="{2}"><span>{3}</span></a>';return!t||t.length<=1?!1:t[0].title?(this.ui.modal.addClass("cms-modal-has-breadcrumb"),i.each(t,function(i,s){var n=i>=t.length-1?"active":"";e+=o.replace("{1}",s.url).replace("{2}",n).replace("{3}",s.title)}),void this.ui.breadcrumb.html(e)):!1},_setButtons:function(t){var e,o,s=t.contents().find(".suit-columns").length>0,n=this,a=i('<div class="cms-modal-item-buttons"></div>'),d=i('<div class="cms-modal-buttons-inner"></div>'),m=i('<a href="#" class="cms-btn">'+CMS.config.lang.cancel+"</a>");e=s?t.contents().find(".save-box:eq(0)"):t.contents().find(".submit-row:eq(0)");var l=t.contents().find("form");l.on("submit",function(){n.hideFrame&&(n.ui.modal.find(".cms-modal-frame iframe").hide(),n.saved=!0)});var r=e.find("input, a, button");r.on("click",function(){i(this).hasClass("default")&&(n.hideFrame=!0)}),t.contents().find(".submit-row").hide(),r.length||(e=t.contents().find("body:not(.change-list) #content form:eq(0)"),r=e.find('input[type="submit"], button[type="submit"]'),r.addClass("deletelink").hide()),r.each(function(t,e){var o=i(e);if(o.attr("data-rel","_"+t),"hidden"===o.attr("type"))return!1;var s=o.attr("value")||o.text(),m="cms-btn";o.is("button")&&(s=o.text()),o.hasClass("default")&&(m="cms-btn cms-btn-action"),o.hasClass("deletelink")&&(m="cms-btn cms-btn-caution");var l=i('<a href="#" class="'+m+" "+o.attr("class")+'">'+s+"</a>");l.on(n.click+" "+n.touchEnd,function(i){i.preventDefault(),o.is("a")&&n._loadIframe({url:o.prop("href"),name:s}),(o.hasClass("default")||o.hasClass("deletelink"))&&(o.hasClass("default")?n.hideFrame=!0:(n.ui.modal.find(".cms-modal-frame iframe").hide(),n.saved=!0)),(o.is("input")||o.is("button"))&&(n.ui.modalBody.addClass("cms-loader"),o[0].click())}),l.wrap(a),d.append(l.parent())}),m.on(n.click,function(i){i.preventDefault(),n._cancelHandler()}),m.wrap(a),d.append(m.parent()),d.find(".cms-btn-group").unwrap(),o=d.find(".cms-btn-group").clone(!0,!0),d.find(".cms-btn-group").remove(),d.append(o.wrapAll(a.clone().addClass("cms-modal-item-buttons-left")).parent()),this.ui.modalButtons.html(d)},_loadIframe:function(t){var e=this;t.url=this.makeURL(t.url),t.title=t.title||"",t.breadcrumbs=t.breadcrumbs||"",CMS.API.Toolbar.showLoader(),this.ui.modal.removeClass("cms-modal-markup"),this.ui.modal.addClass("cms-modal-iframe"),this._setBreadcrumb(t.breadcrumbs);var o=this.ui.frame,s=i('<iframe src="'+t.url+'" class="" frameborder="0" />'),n=this.ui.titlePrefix,a=this.ui.titleSuffix;s.css("visibility","hidden"),n.text(t.title||""),a.text(""),o.find("iframe").css("visibility","hidden"),e.ui.modalBody.addClass("cms-loader"),s.on("load",function(){var o,d,m,l,r,c;try{s.contents()}catch(h){return CMS.API.Messages.open({message:"<strong>"+h+"</strong>",error:!0}),void e.close()}return CMS.Modal._setupCtrlEnterSave(document),s[0].contentWindow&&s[0].contentWindow.document&&CMS.Modal._setupCtrlEnterSave(s[0].contentWindow.document),s[0].contentWindow&&s[0].contentWindow.CMS&&s[0].contentWindow.CMS.CKEditor&&i(s[0].contentWindow.document).ready(function(){setTimeout(function(){var t=s[0].contentWindow.CMS.CKEditor.editor;t&&t.on("loaded",function(t){CMS.Modal._setupCtrlEnterSave(i(t.editor.container.$).find("iframe")[0].contentWindow.document)})},100)}),CMS.API.Toolbar.hideLoader(),d=s.contents().find(".messagelist"),o=d.find("li"),o.length&&CMS.API.Messages.open({message:o.eq(0).html()}),d.remove(),m=s.contents(),l=m.find("body"),l.addClass("cms-admin cms-admin-modal"),e.ui.modalBody.removeClass("cms-loader"),o.length&&e.enforceReload&&e.reloadBrowser(),o.length&&e.enforceClose?(e.close(),!1):(m.find(".viewsitelink").attr("target","_top"),e._setButtons(i(this)),(s.contents().find(".errornote").length||s.contents().find(".errorlist").length)&&(e.saved=!1),void(e.saved&&!m.find(".delete-confirmation").length?e.reloadBrowser(e.options.onClose?e.options.onClose:window.location.href,!1,!0):(s.show(),r=s.contents().find("#content h1:eq(0)"),void 0===t.title&&""===e.ui.titlePrefix.text()&&(c=s.contents().find(".breadcrumbs").contents(),e.ui.titlePrefix.text(c.eq(c.length-1).text().replace("›","").trim())),""===n.text().trim()?n.text(r.text()):a.text(r.text()),r.remove(),s.css("visibility","visible"),s.data("ready",!0),l.on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&e.options.closeOnEsc&&e._cancelHandler()}),m.find(".object-tools").length&&m.find("#content").css("padding-top",38))))}),o.html(s)},_changeIframe:function(i){if(i.hasClass("active"))return!1;var t=i.parent().find("a");t.removeClass("active"),i.addClass("active"),this._loadIframe({url:i.attr("href")}),this.ui.titlePrefix.text(i.text())},_loadMarkup:function(i){this.ui.modal.removeClass("cms-modal-iframe"),this.ui.modal.addClass("cms-modal-markup"),this.ui.modalBody.removeClass("cms-loader"),this.ui.frame.empty().append(i.html),this.ui.titlePrefix.text(i.title||""),this.ui.titleSuffix.text(i.subtitle||"")},_cancelHandler:function(){this.options.onClose=null,this.close()}}),CMS.Modal._setupCtrlEnterSave=function(t){var e=!1,o=navigator.platform.toLowerCase().indexOf("mac")+1;i(t).on("keydown.cms.submit",function(t){t.ctrlKey&&t.keyCode===CMS.KEYS.ENTER&&!o&&i(".cms-modal-buttons .cms-btn-action:first").trigger("click"),o&&(t.keyCode!==CMS.KEYS.CMD_LEFT&&t.keyCode!==CMS.KEYS.CMD_RIGHT&&t.keyCode!==CMS.KEYS.CMD_FIREFOX||(e=!0),t.keyCode===CMS.KEYS.ENTER&&e&&i(".cms-modal-buttons .cms-btn-action:first").trigger("click"))}).on("keyup.cms.submit",function(i){o&&(i.keyCode!==CMS.KEYS.CMD_LEFT&&i.keyCode!==CMS.KEYS.CMD_RIGHT||(e=!1))})}}(CMS.$);
var CMS=window.CMS||{};!function(i){"use strict";CMS.Sideframe=new CMS.Class({implement:[CMS.API.Helpers],options:{onClose:!1,sideframeDuration:300},initialize:function(s){this.options=i.extend(!0,{},this.options,s),this._setupUI(),this.click="click.cms.sideframe",this.pointerDown="pointerdown.cms.sideframe contextmenu.cms.sideframe",this.pointerUp="pointerup.cms.sideframe pointercancel.cms.sideframe",this.pointerMove="pointermove.cms.sideframe",this.enforceReload=!1,this.settingsRefreshTimer=600},_setupUI:function(){var s=i(".cms-sideframe");this.ui={sideframe:s,body:i("html"),window:i(window),dimmer:s.find(".cms-sideframe-dimmer"),close:s.find(".cms-sideframe-close"),frame:s.find(".cms-sideframe-frame"),shim:s.find(".cms-sideframe-shim"),historyBack:s.find(".cms-sideframe-history .cms-icon-arrow-back"),historyForward:s.find(".cms-sideframe-history .cms-icon-arrow-forward")}},_events:function(){var i=this;this.history={back:[],forward:[]},this.ui.close.off(this.click).on(this.click,function(){i.close()}),this.ui.dimmer.off(this.click).on(this.click,function(){i.close()}),this.ui.historyBack.off(this.click).on(this.click,function(){return i.ui.historyBack.hasClass("cms-icon-disabled")?!1:void i._goToHistory("back")}),this.ui.historyForward.off(this.click).on(this.click,function(){return i.ui.historyForward.hasClass("cms-icon-disabled")?!1:void i._goToHistory("forward")})},open:function(i){if(!i||!i.url)throw new Error('The arguments passed to "open" were invalid.');var s=i.url,t=i.animate,e="language="+CMS.config.request.language,o="page_id="+CMS.config.request.page_id,r=[];return this._events(),this.ui.dimmer.show(),this.ui.frame.addClass("cms-loader"),CMS.API&&CMS.API.Toolbar&&CMS.API.Toolbar.showLoader(),s.indexOf(CMS.config.request.tree)>=0&&(CMS.config.request.language&&r.push(e),CMS.config.request.page_id&&r.push(o)),s=this.makeURL(s,r),this._content(s),CMS.settings.sideframe.hidden=!1,this._show(t),this},_content:function(s){function t(){var i=r.ui.sideframe.width();r.ui.sideframe.animate({width:i+1},0),setTimeout(function(){r.ui.sideframe.animate({width:i},0),r.ui.shim.css("z-index",20),setTimeout(function(){r.ui.shim.css("z-index",1)},0)},0)}var e,o,r=this,n=i('<iframe src="'+s+'" class="" frameborder="0" />'),a=this.ui.frame,c=/iPhone|iPod|iPad/.test(navigator.userAgent);n.hide().on("load",function(){try{n.contents()}catch(s){return CMS.API.Messages.open({message:"<strong>"+s+"</strong>",error:!0}),void r.close()}e=n.contents(),o=e.find("body"),o.addClass("cms-admin cms-admin-sideframe"),r.ui.frame.removeClass("cms-loader"),n.show(),c&&t(),CMS.config.debug&&o.addClass("cms-debug"),CMS.settings.sideframe.url=n[0].contentWindow.location.href,CMS.settings=r.setSettings(CMS.settings),o.on(r.click,function(){i(document).trigger(r.click)}),o.on("keydown.cms",function(i){i.keyCode===CMS.KEYS.ESC&&r.close()}),e.find(".viewsitelink").attr("target","_top"),r._addToHistory(this.contentWindow.location.href)}),a.empty(),a.html(n)},_show:function(s){var t=this,e="95%";this.ui.sideframe.show(),s?this.ui.sideframe.animate({width:e,overflow:"visible"},this.options.sideframeDuration):this.ui.sideframe.css("width",e),CMS.API&&CMS.API.Toolbar&&(CMS.API.Toolbar.open(),CMS.API.Toolbar.hideLoader(),CMS.API.Toolbar._lock(!0)),this.ui.body.off("keydown.cms.close").on("keydown.cms.close",function(i){i.keyCode===CMS.KEYS.ESC&&(t.options.onClose=null,t.close())}),this.ui.body.addClass("cms-prevent-scrolling"),this.preventTouchScrolling(i(document),"sideframe")},close:function(){this.ui.dimmer.hide(),CMS.settings.sideframe={url:null,hidden:!1},CMS.settings=this.setSettings(CMS.settings),this.reloadBrowser(this.options.onClose,!1,!0),this._hide({duration:this.options.sideframeDuration/2})},_hide:function(s){var t=this.options.sideframeDuration;s&&"number"==typeof s.duration&&(t=s.duration),this.ui.sideframe.animate({width:0},t,function(){i(this).hide()}),this.ui.frame.removeClass("cms-loader"),CMS.API&&CMS.API.Toolbar&&CMS.API.Toolbar._lock(!1),this.ui.body.off("keydown.cms.close"),this.ui.body.removeClass("cms-prevent-scrolling"),this.allowTouchScrolling(i(document),"sideframe")},_goToHistory:function(i){var s,t=this.ui.frame.find("iframe");"back"===i&&(this.history.forward.push(this.history.back.pop()),t.attr("src",this.history.back[this.history.back.length-1])),"forward"===i&&(s=this.history.forward.pop(),this.history.back.push(s),t.attr("src",s)),this._updateHistoryButtons()},_addToHistory:function(i){this.history.back.push(i);var s=this.history.back.length;this.history.back[s-1]===this.history.back[s-2]&&this.history.back.pop(),this._updateHistoryButtons()},_updateHistoryButtons:function(){this.history.back.length>1?this.ui.historyBack.removeClass("cms-icon-disabled"):this.ui.historyBack.addClass("cms-icon-disabled"),this.history.forward.length>=1?this.ui.historyForward.removeClass("cms-icon-disabled"):this.ui.historyForward.addClass("cms-icon-disabled")}})}(CMS.$);
var CMS=window.CMS||{};!function(i){"use strict";CMS.Clipboard=new CMS.Class({implement:[CMS.API.Helpers],initialize:function(){this._setupUI(),this.click="click.cms.clipboard",this._events()},_setupUI:function(){var o=i(".cms-clipboard");this.ui={clipboard:o,triggers:i(".cms-clipboard-trigger a"),triggerRemove:i(".cms-clipboard-empty a"),pluginsList:o.find(".cms-clipboard-containers"),document:i(document)}},_events:function(){var o=this,a=400,e=117;o.modal=new CMS.Modal({minWidth:a,minHeight:e,minimizable:!1,maximizable:!1,resizable:!1,closeOnEsc:!1}),o.modal.on("cms.modal.loaded cms.modal.closed",function(){i(".cms-add-plugin-placeholder").remove()}).on("cms.modal.closed cms.modal.load",function(){o.ui.pluginsList.prependTo(o.ui.clipboard)}).ui.modal.on("cms.modal.load",function(){o.ui.pluginsList.prependTo(o.ui.clipboard)}),o.ui.triggers.on(o.click,function(t){return t.preventDefault(),t.stopPropagation(),i(this).parent().hasClass("cms-toolbar-item-navigation-disabled")?!1:(o.modal.open({html:o.ui.pluginsList,title:o.ui.clipboard.data("title"),width:a,height:e}),void o.ui.document.trigger("click.cms.toolbar"))}),o.ui.triggerRemove.on(o.click,function(a){return a.preventDefault(),a.stopPropagation(),i(this).parent().hasClass("cms-toolbar-item-navigation-disabled")?!1:void o.clear(function(){o._isClipboardModalOpen()&&o.modal.close(),o.ui.triggers.parent().addClass("cms-toolbar-item-navigation-disabled"),o.ui.triggerRemove.parent().addClass("cms-toolbar-item-navigation-disabled"),o.ui.document.trigger("click.cms.toolbar")})})},_isClipboardModalOpen:function(){return!!this.modal.ui.modalBody.find(".cms-clipboard-containers").length},clear:function(o){var a='{ "csrfmiddlewaretoken": "'+CMS.config.csrf+'" }',e=i(".cms-submenu-item [data-rel=paste]").parent().addClass("cms-submenu-item-disabled");e.find(".cms-submenu-item-paste-tooltip").css("display","none"),e.find(".cms-submenu-item-paste-tooltip-empty").css("display","block"),CMS.API.Toolbar.openAjax({url:CMS.config.clipboard.url,post:a,callback:o})}})}(CMS.$);
var CMS=window.CMS||{};!function(e){"use strict";var t,s,i,n;CMS.Plugin=new CMS.Class({implement:[CMS.API.Helpers],options:{type:"",placeholder_id:null,plugin_type:"",plugin_id:null,plugin_language:"",plugin_parent:null,plugin_order:null,plugin_restriction:[],plugin_parent_restriction:[],urls:{add_plugin:"",edit_plugin:"",move_plugin:"",copy_plugin:"",delete_plugin:""}},initialize:function(t,s){switch(this.options=e.extend(!0,{},this.options,s),this._setupUI(t),this.csrf=CMS.config.csrf,this.click="click.cms.plugin",this.pointerUp="pointerup.cms.plugin",this.pointerDown="pointerdown.cms.plugin",this.pointerOverAndOut="pointerover.cms.plugin pointerout.cms.plugin",this.doubleClick="dblclick.cms.plugin",this.keyUp="keyup.cms.plugin",this.keyDown="keydown.cms.plugin",this.mouseEvents="mousedown.cms.plugin mousemove.cms.plugin mouseup.cms.plugin",this.touchStart="touchstart.cms.plugin",this.touchEnd="touchend.cms.plugin",this.ui.container.data("settings",this.options),CMS.Plugin._initializeDragItemsStates(),this.options.type){case"placeholder":this._setPlaceholder(),this._collapsables();break;case"plugin":this._setPlugin(),this._collapsables();break;default:this._setGeneric()}},_setupUI:function(t){var s=e("."+t);this.ui={container:s,publish:e(".cms-btn-publish"),save:e(".cms-toolbar-item-switch-save-edit"),window:e(window),revert:e(".cms-toolbar-revert"),dragbar:null,draggable:null,draggables:null,submenu:null,dropdown:null}},_setPlaceholder:function(){var t=this;this.ui.dragbar=e(".cms-dragbar-"+this.options.placeholder_id),this.ui.draggables=this.ui.dragbar.closest(".cms-dragarea").find("> .cms-draggables"),this.ui.submenu=this.ui.dragbar.find(".cms-submenu-settings");var s=this.ui.dragbar.find(".cms-dragbar-title"),i=this.ui.dragbar.find(".cms-dragbar-toggler a"),n="cms-dragbar-title-expanded";this._setSettingsMenu(this.ui.submenu),this._setAddPluginModal(this.ui.dragbar.find(".cms-submenu-add")),CMS.settings.dragbars=CMS.settings.dragbars||[],i.off(this.click).on(this.click,function(e){e.preventDefault(),s.hasClass(n)?t._collapseAll(s):t._expandAll(s)}),-1!==e.inArray(this.options.placeholder_id,CMS.settings.dragbars)&&s.addClass(n),this._checkIfPasteAllowed()},_setPlugin:function(){var t=this;this.ui.container.add(this.ui.dragitem).on(this.doubleClick,function(e){e.preventDefault(),e.stopPropagation(),t.editPlugin(t.options.urls.edit_plugin,t.options.plugin_name,t._getPluginBreadcrumbs())}),this.ui.container.on(this.pointerOverAndOut+" "+this.touchStart,function(s){s.stopPropagation(),"touchstart"===s.type&&CMS.API.Tooltip._forceTouchOnce();var i=t.options.plugin_name,n=t.options.plugin_id,a=t._getId(t.ui.dragitem.closest(".cms-dragarea")),o=e(".cms-placeholder-"+a);o.length&&o.data("settings")&&(i=o.data("settings").name+": "+i),CMS.API.Tooltip.displayToggle("pointerover"===s.type||"touchstart"===s.type,s,i,n)}),this.ui.container.on("cms.plugins.update",function(e){e.stopPropagation(),t.movePlugin()}),this.ui.container.on("cms.plugin.update",function(s){s.stopPropagation();var i=e(s.delegateTarget),n=e(".cms-draggable-"+i.data("settings").plugin_id),a=t._getId(n.parents(".cms-draggables").last().prevAll(".cms-dragbar").first());if(!a)return!1;var o=i.data("settings");o.target=a,o.parent=t._getId(n.parent().closest(".cms-draggable")),o.move_a_copy=!0,t.movePlugin(o)}),this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id),this.ui.dragitem=this.ui.draggable.find("> .cms-dragitem"),this.ui.draggables=this.ui.draggable.find("> .cms-draggables"),this.ui.submenu=this.ui.dragitem.find(".cms-submenu"),this._setSettingsMenu(this.ui.submenu),this._setAddPluginModal(this.ui.dragitem.find(".cms-submenu-add")),this._checkIfPasteAllowed()},_setGeneric:function(){var e=this;this.ui.container.on(this.doubleClick,function(t){t.preventDefault(),t.stopPropagation(),e.editPlugin(e.options.urls.edit_plugin,e.options.plugin_name,[])}),this.ui.container.on(this.pointerOverAndOut+" "+this.touchStart,function(t){"touchstart"!==t.type&&t.stopPropagation();var s=e.options.plugin_name,i=e.options.plugin_id;CMS.API.Tooltip.displayToggle("pointerover"===t.type||"touchstart"===t.type,t,s,i)})},_checkIfPasteAllowed:function(){var t=this.ui.dropdown.find("[data-rel=paste]"),s=t.parent();if(!n.length)return s.addClass("cms-submenu-item-disabled"),s.find(".cms-submenu-item-paste-tooltip-empty").css("display","block"),!1;if(this.ui.draggable&&this.ui.draggable.hasClass("cms-draggable-disabled"))return s.addClass("cms-submenu-item-disabled"),s.find(".cms-submenu-item-paste-tooltip-disabled").css("display","block"),!1;var i=this.options.plugin_restriction;if(!n.data("settings"))return!1;var a=n.data("settings").plugin_type,o=e.grep(n.data("settings").plugin_parent_restriction,function(e){return"0"!==e}),l=this.options.plugin_type;return i.length&&-1===e.inArray(a,i)||o.length&&-1===e.inArray(l,o)?(s.addClass("cms-submenu-item-disabled"),s.find(".cms-submenu-item-paste-tooltip-restricted").css("display","block"),!1):!0},addPlugin:function(t,s,i){var n={placeholder_id:this.options.placeholder_id,plugin_type:t,plugin_language:this.options.plugin_language};i&&(n.plugin_parent=i);var a=this.options.urls.add_plugin+"?"+e.param(n),o=new CMS.Modal({onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});o.open({url:a,title:s}),o.on("cms.modal.closed",function(){e(".cms-add-plugin-placeholder").remove()})},editPlugin:function(t,s,i){var n=new CMS.Modal({onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.on("cms.modal.loaded",function(){e(".cms-add-plugin-placeholder").remove()}),n.on("cms.modal.closed",function(){e(".cms-add-plugin-placeholder").remove()}),n.open({url:t,title:s,breadcrumbs:i,width:850})},copyPlugin:function(t,s){if(CMS.API.locked)return!1;CMS.API.locked=!0;var i=!(!t&&!s),n=t||this.options,a=s;a?(n.target=n.placeholder_id,n.plugin_id="",n.parent=""):a=n.plugin_language;var o={source_placeholder_id:n.placeholder_id,source_plugin_id:n.plugin_id||"",source_language:a,target_plugin_id:n.parent||"",target_placeholder_id:n.target||CMS.config.clipboard.id,target_language:n.page_language||a,csrfmiddlewaretoken:this.csrf},l={type:"POST",url:n.urls.copy_plugin,data:o,success:function(){CMS.API.Messages.open({message:CMS.config.lang.success}),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;CMS.API.Messages.open({message:t+e.responseText||e.status+" "+e.statusText,error:!0})}};i?e.ajax(l):CMS.API.Clipboard.clear(function(){e.ajax(l)})},cutPlugin:function(){if(CMS.API.locked)return!1;CMS.API.locked=!0;var t=this,s={placeholder_id:CMS.config.clipboard.id,plugin_id:this.options.plugin_id,plugin_parent:"",plugin_language:this.options.page_language,plugin_order:[this.options.plugin_id],csrfmiddlewaretoken:this.csrf};CMS.API.Clipboard.clear(function(){return CMS.API.locked?!1:(CMS.API.locked=!0,void e.ajax({type:"POST",url:t.options.urls.move_plugin,data:s,success:function(){CMS.API.Messages.open({message:CMS.config.lang.success}),CMS.API.Helpers.reloadBrowser()},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;CMS.API.Messages.open({message:t+e.responseText||e.status+" "+e.statusText,error:!0})}}))})},pastePlugin:function(){i.appendTo(this.ui.draggables),this.ui.draggables.trigger("cms.update"),n.trigger("cms.plugin.update")},movePlugin:function(t){if(CMS.API.locked)return!1;CMS.API.locked=!0;var s=this,i=t||this.options,n=e(".cms-plugin-"+i.plugin_id),a=e(".cms-draggable-"+i.plugin_id);this._setPosition(i.plugin_id,n,a);var o=this._getId(a.parents(".cms-draggables").last().prevAll(".cms-dragbar").first()),l=this._getId(a.parent().closest(".cms-draggable")),r=this._getIds(a.siblings(".cms-draggable").andSelf());if(i.move_a_copy&&(r=r.map(function(e){var t=e;return t===i.plugin_id&&(t="__COPY__"),t})),o===!1)return!1;var d={placeholder_id:o,plugin_id:i.plugin_id,plugin_parent:l||"",plugin_language:i.page_language,plugin_order:r,csrfmiddlewaretoken:this.csrf,move_a_copy:i.move_a_copy};CMS.API.Toolbar.showLoader(),e.ajax({type:"POST",url:i.urls.move_plugin,data:d,success:function(e){e.reload&&CMS.API.Helpers.reloadBrowser(),e.urls&&s._setSettings(i,{urls:e.urls}),CMS.API.locked=!1,CMS.API.Toolbar.hideLoader(),s._showSuccess(a),CMS.Plugin._updateRegistry({pluginId:i.plugin_id,update:{plugin_parent:l||"",placeholder_id:o}}),s._setSettings(s.options,{plugin_parent:l||"",placeholder_id:o})},error:function(e){CMS.API.locked=!1;var t=CMS.config.lang.error;CMS.API.Messages.open({message:t+e.responseText||e.status+" "+e.statusText,error:!0}),CMS.API.Toolbar.hideLoader()}}),this.ui.publish.addClass("cms-btn-publish-active").removeClass("cms-btn-disabled").parent().show(),this.ui.window.trigger("resize"),this.ui.revert.removeClass("cms-toolbar-item-navigation-disabled")},_setSettings:function(t,s){var i=e.extend(!0,{},t,s),n=e(".cms-plugin-"+i.plugin_id);this.options=i,n.data("settings",i)},deletePlugin:function(t,s,i){var n=new CMS.Modal({onClose:this.options.onClose||!1,redirectOnClose:this.options.redirectOnClose||!1});n.on("cms.modal.loaded",function(){e(".cms-add-plugin-placeholder").remove()}),n.open({url:t,title:s,breadcrumbs:i})},_setPosition:function(t,s,i){var n=i.prev(".cms-draggable"),a=i.next(".cms-draggable"),o=i.parent().closest(".cms-draggable"),l=e(".cms-plugin-"+this._getId(o)),r=i.closest(".cms-dragarea");if(n.length)s.insertAfter(e(".cms-plugin-"+this._getId(n)));else if(a.length)s.insertBefore(e(".cms-plugin-"+this._getId(a)));else if(o.length){for(;l.children().length;)l=l.children();l.append(s)}else r.length?s.insertAfter(e(".cms-placeholder-"+this._getId(r))):CMS.API.Helpers.reloadBrowser()},editPluginPostAjax:function(e,t){this.editPlugin(t.url,this.options.plugin_name,t.breadcrumb)},_setSettingsMenu:function(t){var s=this;this.ui.dropdown=t.siblings(".cms-submenu-dropdown-settings");var i=this.ui.dropdown;t.on(this.pointerUp,function(t){t.preventDefault(),t.stopPropagation();var i=e(this);i.hasClass("cms-btn-active")?CMS.Plugin._hideSettingsMenu(i):(CMS.Plugin._hideSettingsMenu(),s._showSettingsMenu(i))}).on(this.touchStart,function(e){e.stopPropagation()}),i.on(this.mouseEvents,function(e){e.stopPropagation()}).on(this.touchStart,function(e){e.stopPropagation()}),s._setupActions(t),t.on([this.pointerUp,this.pointerDown,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()}),t.siblings(".cms-quicksearch, .cms-submenu-dropdown-settings").on([this.pointerUp,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()})},_scrollToElement:function(t,s){var i=200,n=50,a=s&&void 0!==s.duration?s.duration:i,o=s&&void 0!==s.offset?s.offset:n,l=t.offsetParent(),r=e(window),d=r.height(),u=l.scrollTop(),c=t.position().top,g=t.height(),p=d>=c+g+o;p||l.animate({scrollTop:c+o+g+u-d},a)},_setAddPluginModal:function(t){if(t.hasClass("cms-btn-disabled"))return!1;var s,i,n=this,a=e('<div class="cms-add-plugin-placeholder">'+CMS.config.lang.addPluginPlaceholder+"</div>"),o=new CMS.Modal({minWidth:400,minHeight:400}),l=t.closest(".cms-dragitem"),r=!l.length;s=r?t.closest(".cms-dragarea").find("> .cms-draggables"):t.closest(".cms-draggable").find("> .cms-draggables"),o.on("cms.modal.loaded",e.proxy(n._setupKeyboardTraversing,n)),o.on("cms.modal.loaded",function(){s.hasClass("cms-hidden")&&!r&&n._toggleCollapsable(l),e(".cms-add-plugin-placeholder").remove(),a.appendTo(s),n._scrollToElement(a)}),o.on("cms.modal.closed",function(){e(".cms-add-plugin-placeholder").remove()}),o.on("cms.modal.shown",function(){var t=e(".cms-modal-markup .cms-plugin-picker");i||t.find("input").trigger("focus"),i=!1});var d=t.siblings(".cms-plugin-picker");n._setupQuickSearch(d),t.on(this.touchStart,function(e){i=!0,e.stopPropagation()}).on(this.pointerUp,function(e){e.preventDefault(),e.stopPropagation(),CMS.Plugin._hideSettingsMenu();var s=d.clone(!0,!0).data("parentId",n._getId(t.closest(".cms-draggable"))).append(n._getPossibleChildClasses());o.open({title:n.options.addPluginHelpTitle,html:s,width:530,height:400})}),t.on([this.pointerUp,this.pointerDown,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()}),t.siblings(".cms-quicksearch, .cms-submenu-dropdown").on([this.pointerUp,this.click,this.doubleClick].join(" "),function(e){e.stopPropagation()})},_getPossibleChildClasses:function(){var t=this,s=this.options.plugin_restriction,i=t._getId(t.ui.submenu.closest(".cms-dragarea")),n=e(e("#cms-plugin-child-classes-"+i).html());return s&&s.length&&(n=n.filter(function(){var t=e(this);return t.hasClass("cms-submenu-item-title")||-1!==s.indexOf(t.find("a").attr("href"))}),n=n.filter(function(t){var s=e(this);return!s.hasClass("cms-submenu-item-title")||s.hasClass("cms-submenu-item-title")&&!n.eq(t+1).hasClass("cms-submenu-item-title")&&n.eq(t+1).length})),n.find("a").on(t.click,t._delegate.bind(t)),n},_setupQuickSearch:function(t){var s=this,i=100,n=110,a=CMS.API.Helpers.debounce(function(){var t=e(this),i=t.closest(".cms-plugin-picker");s._filterPluginsList(i,t)},i);t.find("> .cms-quicksearch").find("input").on(this.keyUp,a).on(this.keyUp,CMS.API.Helpers.debounce(function(t){var s,i;t.keyCode===CMS.KEYS.ENTER&&(s=e(this),i=s.closest(".cms-plugin-picker"),i.find(".cms-submenu-item").not(".cms-submenu-item-title").filter(":visible").first().find("> a").focus().trigger("click"))},n))},_setupActions:function(e){var t=".cms-submenu-edit, .cms-submenu-item a";e.parent().find(".cms-submenu-edit").on(this.touchStart,function(e){e.stopPropagation()}),e.parent().find(t).on(this.click,e,this._delegate.bind(this))},_delegate:function(t){t.preventDefault(),t.stopPropagation();var s,i=this;t.data&&t.data.nav&&(s=t.data.nav),CMS.API.Toolbar.showLoader();var n=".cms-submenu-edit, .cms-submenu-item a",a=e(t.target).closest(n);switch(CMS.Plugin._hideSettingsMenu(s),a.attr("data-rel")){case"add":i.addPlugin(a.attr("href").replace("#",""),a.text(),a.closest(".cms-plugin-picker").data("parentId"));break;case"ajax_add":CMS.API.Toolbar.openAjax({url:a.attr("href"),post:JSON.stringify(a.data("post")),text:a.data("text"),callback:e.proxy(i.editPluginPostAjax,i),onSuccess:a.data("on-success")});break;case"edit":i.editPlugin(i.options.urls.edit_plugin,i.options.plugin_name,i._getPluginBreadcrumbs());break;case"copy-lang":i.copyPlugin(i.options,a.attr("data-language"));break;case"copy":a.parent().hasClass("cms-submenu-item-disabled")?CMS.API.Toolbar.hideLoader():i.copyPlugin();break;case"cut":i.cutPlugin();break;case"paste":a.parent().hasClass("cms-submenu-item-disabled")?CMS.API.Toolbar.hideLoader():i.pastePlugin();break;case"delete":i.deletePlugin(i.options.urls.delete_plugin,i.options.plugin_name,i._getPluginBreadcrumbs());break;default:CMS.API.Toolbar.hideLoader(),CMS.API.Toolbar._delegate(a)}},_setupKeyboardTraversing:function(){var s=e(".cms-modal-markup .cms-plugin-picker");s.length&&(t.off(this.keyDown+".traverse"),t.on(this.keyDown+".traverse",function(e){var t=s.find(".cms-submenu-item:visible a"),i=t.index(t.filter(":focus"));(e.keyCode===CMS.KEYS.DOWN||e.keyCode===CMS.KEYS.TAB&&!e.shiftKey)&&(e.preventDefault(),i>=0&&i<t.length-1?t.eq(i+1).focus():t.eq(0).focus()),(e.keyCode===CMS.KEYS.UP||e.keyCode===CMS.KEYS.TAB&&e.shiftKey)&&(e.preventDefault(),t.is(":focus")?t.eq(i-1).focus():t.eq(t.length).focus())}))},_showSettingsMenu:function(e){var t=this.ui.dropdown,s=e.parentsUntil(".cms-dragarea").last(),i=10;e.addClass("cms-btn-active"),s.addClass("cms-z-index-9999"),t.show(),this.ui.window.height()+this.ui.window.scrollTop()-e.offset().top-t.height()<=i&&e.offset().top-t.height()>=0?t.removeClass("cms-submenu-dropdown-top").addClass("cms-submenu-dropdown-bottom"):t.removeClass("cms-submenu-dropdown-bottom").addClass("cms-submenu-dropdown-top")},_filterPluginsList:function(t,s){var i=t.find(".cms-submenu-item"),n=t.find(".cms-submenu-item-title"),a=s.val();return""===a?(i.add(n).show(),!1):(i.find("a, span").each(function(t,s){var i=e(s),n=i.text().toLowerCase(),o=a.toLowerCase();n.indexOf(o)>=0?i.parent().show():i.parent().hide()}),n.filter(":visible").each(function(t,s){n.hide(),e(s).nextUntil(".cms-submenu-item-title").show()}),void i.filter(":visible").each(function(t,s){var i=e(s);i.prev().hasClass("cms-submenu-item-title")?i.prev().show():i.prevUntil(".cms-submenu-item-title").last().prev().show()}))},_toggleCollapsable:function(s){var i,n=this,a=n._getId(s.parent()),o=this.ui.draggable,l=CMS.settings;if(l.states=l.states||[],s.hasClass("cms-dragitem-expanded")){if(l.states.splice(e.inArray(a,l.states),1),s.removeClass("cms-dragitem-expanded").parent().find("> .cms-collapsable-container").addClass("cms-hidden"),t.data("expandmode")){if(i=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){var t=e(this);t.hasClass("cms-dragitem-expanded")&&n._toggleCollapsable(t)})}}else if(l.states.push(a),s.addClass("cms-dragitem-expanded").parent().find("> .cms-collapsable-container").removeClass("cms-hidden"),t.data("expandmode")){if(i=o.find(".cms-draggable").find(".cms-dragitem-collapsable"),!i.length)return!1;i.each(function(){var t=e(this);t.hasClass("cms-dragitem-expanded")||n._toggleCollapsable(t)})}this.ui.window.trigger("resize.sideframe"),CMS.API.Toolbar.setSettings(l)},_collapsables:function(){var t=this;this.ui.draggable=e(".cms-draggable-"+this.options.plugin_id);var s=this.ui.draggable.find("> .cms-dragitem");return this.ui.container.each(function(t,s){var i=e(s).find(".cms-dragitem-collapsable"),n=i.filter(".cms-dragitem-expanded");i.length===n.length&&i.length+n.length!==0&&e(s).find(".cms-dragbar-title").addClass("cms-dragbar-title-expanded")}),this.ui.draggable.length?(s.find("> .cms-dragitem-text").on(this.touchEnd+" "+this.click,CMS.API.Helpers.debounce(function(){s.hasClass("cms-dragitem-collapsable")&&t._toggleCollapsable(s)},0)),void this.ui.draggable.on(this.doubleClick,function(s){s.stopPropagation(),e(".cms-plugin-"+t._getId(e(this))).trigger("dblclick.cms")})):!1},_expandAll:function(t){var s=this,i=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");if(!i.length)return!1;i.each(function(){var t=e(this);t.hasClass("cms-dragitem-expanded")||s._toggleCollapsable(t)}),t.addClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.push(this.options.placeholder_id),CMS.API.Toolbar.setSettings(n)},_collapseAll:function(t){var s=this,i=t.closest(".cms-dragarea").find(".cms-dragitem-collapsable");i.each(function(){var t=e(this);t.hasClass("cms-dragitem-expanded")&&s._toggleCollapsable(t)}),t.removeClass("cms-dragbar-title-expanded");var n=CMS.settings;n.dragbars=n.dragbars||[],n.dragbars.splice(e.inArray(this.options.placeholder_id,n.states),1),CMS.API.Toolbar.setSettings(n)},_getId:function(e){return CMS.API.StructureBoard.getId(e)},_getIds:function(e){return CMS.API.StructureBoard.getIds(e)},_showSuccess:function(t){var s=e('<div class="cms-dragitem-success"></div>'),i=1e3;t.addClass("cms-draggable-success").append(s),s.fadeOut(i,function(){e(this).remove(),t.removeClass("cms-draggable-success")}),this.ui.window.trigger("resize.sideframe")},_getPluginBreadcrumbs:function(){var t=[];t.unshift({title:this.options.plugin_name,url:this.options.urls.edit_plugin});for(var s,i=function(t){return e.grep(CMS._plugins||[],function(e){return e[0]==="cms-plugin-"+t})[0]},n=this.options.plugin_parent;n&&"None"!==n&&(s=i(n));)t.unshift({title:s[1].plugin_name,url:s[1].urls.edit_plugin}),n=s[1].plugin_parent;return t}}),CMS.Plugin._updateRegistry=function(t){var s=(CMS._plugins||[]).findIndex(function(e){return e[0]==="cms-plugin-"+t.pluginId});-1!==s&&e.extend(!0,CMS._plugins[s][1],t.update)},CMS.Plugin._hideSettingsMenu=function(t){var s=t||e(".cms-submenu-btn.cms-btn-active");s.length&&(s.removeClass("cms-btn-active"),s.closest(".cms-draggable").data("active",!1),e(".cms-z-index-9999").removeClass("cms-z-index-9999"),s.siblings(".cms-submenu-dropdown").hide(),s.siblings(".cms-quicksearch").hide(),s.siblings(".cms-quicksearch").find("input").val("").trigger(this.keyUp).blur(),e(".cms-dragbar").css("position",""))},CMS.Plugin._initializeGlobalHandlers=function(){var a,o=0;t=e(document),s=e(".cms-clipboard"),i=s.find(".cms-draggable:first"),n=s.find(".cms-plugin:first"),t.on("pointerup.cms.plugin",function(){CMS.Plugin._hideSettingsMenu()}).on("keydown.cms.plugin",function(e){e.keyCode===CMS.KEYS.SHIFT&&t.data("expandmode",!0)}).on("keyup.cms.plugin",function(e){e.keyCode===CMS.KEYS.SHIFT&&t.data("expandmode",!1)}).on("click.cms.plugin",".cms-plugin a, a:has(.cms-plugin)",function(t){var s=300;t.shiftKey||t.ctrlKey||t.metaKey||t.isDefaultPrevented()||(t.preventDefault(),1===++o?a=setTimeout(function(){var s=e(t.currentTarget);o=0,window.open(s.attr("href"),s.attr("target")||"_self")},s):(clearTimeout(a),o=0))})},CMS.Plugin._initializeDragItemsStates=CMS.API.Helpers.once(function(){for(var t=CMS.settings.states||[],s=t.sort(),i=[],n=0;n<s.length;n++)s[n]!==s[n+1]&&i.push(s[n]);CMS.settings.states=i,e.each(CMS.settings.states,function(t,s){var i=e(".cms-draggable-"+s);i.find(".cms-draggables").length&&(i.find("> .cms-collapsable-container").removeClass("cms-hidden"),i.find("> .cms-dragitem").addClass("cms-dragitem-expanded"))})}),e(CMS.Plugin._initializeGlobalHandlers)}(CMS.$);
var CMS=window.CMS||{};!function(e){"use strict";function t(){i.each(function(){var t=e(this),s=t.find('.cms-dragbar .cms-submenu-item:has(a[data-rel="copy"]):first');t.find("> .cms-draggables").children(".cms-draggable:not(.cms-draggable-is-dragging)").length?(t.removeClass("cms-dragarea-empty"),s.removeClass("cms-submenu-item-disabled")):(t.addClass("cms-dragarea-empty"),s.addClass("cms-submenu-item-disabled"))})}function s(t){t.each(function(){var t=e(this),s=t.closest(".cms-draggable").find("> .cms-dragitem");t.children().length?s.addClass("cms-dragitem-collapsable cms-dragitem-expanded"):s.removeClass("cms-dragitem-collapsable")})}var i;CMS.StructureBoard=new CMS.Class({implement:[CMS.API.Helpers],initialize:function(){this._setupUI(),this.click="click.cms",this.pointerUp="pointerup.cms",this.state=!1,this.dragging=!1,this._setup(),this._setupModeSwitcher(),t()},_setupUI:function(){var t=e(".cms-structure"),s=e(".cms-toolbar");this.ui={container:t,content:e(".cms-structure-content"),doc:e(document),window:e(window),html:e("html"),toolbar:s,sortables:e(".cms-draggables"),plugins:e(".cms-plugin"),render_model:e(".cms-render-model"),placeholders:e(".cms-placeholder"),dragitems:e(".cms-draggable"),dragareas:e(".cms-dragarea"),toolbarModeSwitcher:s.find(".cms-toolbar-item-cms-mode-switcher"),toolbarModeLinks:s.find(".cms-toolbar-item-cms-mode-switcher a"),toolbarTrigger:e(".cms-toolbar-trigger")}},_setup:function(){var e=this;return this.ui.dragareas.length&&this.ui.toolbarModeSwitcher.length?("structure"===CMS.settings.mode?e.show(!0):e.hide(!0),this.ui.placeholders.length&&this.ui.toolbarModeSwitcher.show(),void this._drag()):!1},_setupModeSwitcher:function(){var e=this,t=e.ui.toolbarModeLinks;t.eq(1).on(e.click+" "+e.pointerUp,function(t){return t.preventDefault(),"edit"===CMS.settings.mode?!1:void e.hide()}),t.eq(0).on(e.click+" "+e.pointerUp,function(t){return t.preventDefault(),"structure"===CMS.settings.mode?!1:void e.show()}),e.ui.toolbarModeSwitcher.length&&e.ui.doc.on("keydown.cms.structureboard.switcher",function(t){var s=document.activeElement!==document.body;t.keyCode!==CMS.KEYS.SPACE||s||(t.preventDefault(),"structure"===CMS.settings.mode?e.hide():"edit"===CMS.settings.mode&&e.show())})},show:function(e){if("live"===CMS.config.mode)return!1;var t=this.ui.toolbar.width(),s=this.ui.window[0].innerWidth-t;s&&(this.ui.toolbar.css("right",s),this.ui.toolbarTrigger.css("right",s));var i=this.ui.toolbarModeLinks;i.removeClass("cms-btn-active").eq(0).addClass("cms-btn-active"),this.ui.html.removeClass("cms-structure-mode-content").addClass("cms-structure-mode-structure"),CMS.settings.mode="structure",e||(CMS.settings=this.setSettings(CMS.settings)),this.ui.dragareas.show(),this._showBoard()},hide:function(e){if("live"===CMS.config.mode)return!1;this.ui.toolbar.css("right",""),this.ui.toolbarTrigger.css("right","");var t=this.ui.toolbarModeLinks;t.removeClass("cms-btn-active").eq(1).addClass("cms-btn-active"),this.ui.html.removeClass("cms-structure-mode-structure").addClass("cms-structure-mode-content"),CMS.settings.mode="edit",e||(CMS.settings=this.setSettings(CMS.settings)),this._hideBoard()},getId:function(e){if(void 0===e||null===e||e.length<=0)return!1;var t=null,s=e.attr("class").split(" ")[1];return e.hasClass("cms-plugin")?t=s.replace("cms-plugin-",""):e.hasClass("cms-draggable")?t=s.replace("cms-draggable-",""):e.hasClass("cms-placeholder")?t=s.replace("cms-placeholder-",""):e.hasClass("cms-dragbar")?t=s.replace("cms-dragbar-",""):e.hasClass("cms-dragarea")&&(t=s.replace("cms-dragarea-","")),t},getIds:function(t){var s=this,i=[];return t.each(function(){i.push(s.getId(e(this)))}),i},_showBoard:function(){this.ui.container.show(),this.ui.dragareas.css("opacity",1),this.ui.plugins.not(this.ui.render_model).hide(),this.ui.placeholders.show();var t=this.ui.content,s=t.find(".cms-dragarea");s.each(function(s,i){e(i).hasClass("cms-dragarea-static")&&t.append(i)}),s.filter(".cms-dragarea-static").eq(0).css("margin-top","50px")},_hideBoard:function(){this.ui.container.hide(),this.ui.plugins.show(),this.ui.placeholders.hide(),this.ui.window.off("resize.sideframe"),this.ui.window.trigger("structureboard_hidden.sideframe");try{var e=document.createEvent("UIEvents");e.initUIEvent("resize",!0,!1,window,0),window.dispatchEvent(e)}catch(t){}},_drag:function(){var i,a=this;this.ui.sortables.nestedSortable({items:"> .cms-draggable:not(.cms-draggable-disabled .cms-draggable)",placeholder:"cms-droppable",connectWith:".cms-draggables:not(.cms-hidden)",tolerance:"intersect",toleranceElement:"> div",dropOnEmpty:!0,helper:function(e,t){var s=t.find("> .cms-dragitem").clone();return s.wrap('<div class="'+t[0].className+'"></div>'),s.parent()},appendTo:".cms-structure-content",cursor:"move",cursorAt:{left:-15,top:-15},opacity:1,zIndex:9999999,delay:100,tabSize:15,listType:"div.cms-draggables",doNotClear:!0,disableNestingClass:"cms-draggable-disabled",errorClass:"cms-draggable-disallowed",scrollSpeed:15,scrollSensitivity:.2*a.ui.window.height(),start:function(s,r){a.ui.content.attr("data-touch-action","none"),i=r.item.closest(".cms-draggables"),a.dragging=!0,t(),CMS.Plugin._hideSettingsMenu(),a.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.removeClass("cms-hidden")}),r.item.addClass("cms-is-dragging"),r.helper.addClass("cms-draggable-is-dragging"),r.item.find("> .cms-draggables").children().length&&r.helper.addClass("cms-draggable-stack"),a.ui.doc.on("keyup.cms.interrupt",function(t,s){(t.keyCode===CMS.KEYS.ESC&&a.dragging||s)&&(a.state=!1,e.ui.sortable.prototype._mouseStop(),a.ui.sortables.trigger("mouseup"))})},beforeStop:function(e,t){a.dragging=!1,t.item.removeClass("cms-is-dragging cms-draggable-stack"),a.ui.doc.off("keyup.cms.interrupt"),a.ui.content.attr("data-touch-action","pan-y")},update:function(r,n){if(!a.state)return!1;var c=n.item.closest(".cms-draggables");if(i.is(c)){if(!c.is(this))return!1}else s(c.add(i));var d=a.getId(n.item),o=e(".cms-plugin-"+d);o.closest(".cms-clipboard").length?o.trigger("cms.plugin.update"):o.trigger("cms.plugins.update"),a.ui.sortables.each(function(){var t=e(this);0===t.children().length&&t.addClass("cms-hidden")}),t()},isAllowed:function(t,s,i){if(CMS.API.locked)return!1;var r,n=[];if(t&&t.closest(".cms-clipboard-containers").length)return!1;if(t&&t.parent().hasClass("cms-draggable-disabled"))return!1;var c=e(".cms-plugin-"+a.getId(i));if(0===c.length||!c.data("settings"))return!1;var d,o=e.grep(c.data("settings").plugin_parent_restriction,function(e){return"0"!==e}),l=c.data("settings").plugin_type,g=a.getId(t.closest(".cms-dragarea")),u=e(".cms-placeholder-"+g);return d=e(s&&s.length?".cms-plugin-"+a.getId(s.closest(".cms-draggable")):".cms-plugin-"+a.getId(t.closest(".cms-draggable"))),u.length&&(n=u.data("settings").plugin_restriction,r=u.data("settings").plugin_type),d.length&&(n=d.data("settings").plugin_restriction,r=d.data("settings").plugin_type),a.state=!(n.length&&-1===e.inArray(l,n)),o.length&&(a.state=-1!==e.inArray(r,o)),a.state}}).on("cms.update",t)}}),CMS.StructureBoard._initializeGlobalHandlers=function(){i=e(".cms-dragarea:not(.cms-clipboard-containers)")},e(CMS.StructureBoard._initializeGlobalHandlers)}(CMS.$);
var CMS=window.CMS||{};!function(t){"use strict";CMS.Navigation=new CMS.Class({implement:[CMS.API.Helpers],initialize:function(){this._setupUI(),this._getWidths(),this.rightMostItemIndex=this.items.left.length-1,this.leftMostItemIndex=0,this.resize="resize.cms.navigation",this.load="load.cms.navigation",this.orientationChange="orientationchange.cms.navigation",this._events()},_setupUI:function(){var i=t(".cms"),e=i.find(".cms-toolbar-more");this.ui={window:t(window),toolbarLeftPart:i.find(".cms-toolbar-left"),toolbarRightPart:i.find(".cms-toolbar-right"),trigger:e,dropdown:e.find("> ul"),toolbarTrigger:i.find(".cms-toolbar-trigger"),logo:i.find(".cms-toolbar-item-logo")}},_events:function(){var t=50;this.ui.window.on([this.resize,this.load,this.orientationChange].join(" "),CMS.API.Helpers.throttle(this._handleResize.bind(this),t))},_getWidths:function(){var i=this;i.items={left:[],leftTotalWidth:0,right:[],rightTotalWidth:0,moreButtonWidth:0};var e=i.ui.toolbarLeftPart.find(".cms-toolbar-item-navigation > li:not(.cms-toolbar-more)"),o=i.ui.toolbarRightPart.find("> .cms-toolbar-item"),s=function(i,e){var o=t(i),s=t(i).outerWidth(!0);e.push({element:o,width:s})},h=function(t,i){return t+i.width};e.each(function(){s(this,i.items.left)}),o.each(function(){s(this,i.items.right)}),i.items.leftTotalWidth=i.items.left.reduce(h,0),i.items.rightTotalWidth=i.items.right.reduce(h,0),i.items.moreButtonWidth=i.ui.trigger.outerWidth()},_calculateAvailableWidth:function(){var t=15,i=this.ui.window.width(),e=parseInt(this.ui.toolbarRightPart.css("padding-right"),10)+this.ui.logo.offset().left+this.ui.logo.outerWidth(!0)+t;return i-e},_showDropdown:function(){this.ui.trigger.css("display","list-item")},_hideDropdown:function(){this.ui.trigger.css("display","none")},_handleResize:function(){var t,i=this._calculateAvailableWidth();if(i>this.items.leftTotalWidth+this.items.rightTotalWidth)this._showAll();else{t=i-this.items.moreButtonWidth-this.items.rightTotalWidth;for(var e=-1;t-this.items.left[e+1].width>=0;)t-=this.items.left[e+1].width,e++;if(e<this.rightMostItemIndex?this._moveToDropdown(this.rightMostItemIndex-e):this.rightMostItemIndex<e&&this._moveOutOfDropdown(e-this.rightMostItemIndex),this._showDropdown(),0>t&&-1===this.rightMostItemIndex){t+=this.items.rightTotalWidth;var o=this.items.right.length;this._moveToDropdown(o-this.leftMostItemIndex,"right"),this.ui.dropdown.addClass("cms-more-dropdown-full")}else this._showAllRight(),this.ui.dropdown.removeClass("cms-more-dropdown-full")}},_showAll:function(){this._showAllLeft(),this._showAllRight(),this._hideDropdown()},_showAllLeft:function(){this._moveOutOfDropdown(this.items.left.length-1-this.rightMostItemIndex)},_showAllRight:function(){this._moveOutOfDropdown(this.leftMostItemIndex,"right")},_moveToDropdown:function(t,i){if(!(0>=t)){var e,o,s,h;if("right"===i){for(o=this.leftMostItemIndex,s=this.leftMostItemIndex+t-1,h=o;s>=h;h++)e=this.items.right[h].element,this.ui.dropdown.prepend(e.wrap('<li class="cms-more-buttons"></li>').parent());this.leftMostItemIndex+=t}else{for(s=this.rightMostItemIndex,o=this.rightMostItemIndex-t+1,h=s;h>=o;h--)e=this.items.left[h].element,this.ui.dropdown.prepend(e),e.find("> ul").children().length&&e.addClass("cms-toolbar-item-navigation-children");this.rightMostItemIndex-=t}}},_moveOutOfDropdown:function(t,i){if(!(0>=t)){var e,o,s,h;if("right"===i){for(h=this.leftMostItemIndex-1,s=this.leftMostItemIndex-t,e=h;e>=s;e--)o=this.items.right[e].element,o.unwrap("<li></li>"),o.prependTo(this.ui.toolbarRightPart);this.leftMostItemIndex-=t}else{for(s=this.rightMostItemIndex+1,h=this.rightMostItemIndex+t,e=s;h>=e;e++)o=this.items.left[e].element,o.insertBefore(this.ui.trigger),o.removeClass("cms-toolbar-item-navigation-children"),o.find("> ul").removeAttr("style");this.rightMostItemIndex+=t}}}})}(CMS.$);
var CMS=window.CMS||{};!function(t){"use strict";var i=1e3,o=10,s=5;CMS.Toolbar=new CMS.Class({implement:[CMS.API.Helpers],options:{toolbarDuration:200},initialize:function(i){this.options=t.extend(!0,{},this.options,i),this._setupUI(),this.navigation=new CMS.Navigation,this._position={top:0,stickyTop:0,isSticky:!0},this.click="click.cms.toolbar",this.touchStart="touchstart.cms.toolbar",this.pointerUp="pointerup.cms.toolbar",this.pointerOverOut="pointerover.cms.toolbar pointerout.cms.toolbar",this.pointerLeave="pointerleave.csm.toolbar",this.mouseEnter="mouseenter.cms.toolbar",this.mouseLeave="mouseleave.cms.toolbar",this.resize="resize.cms.toolbar",this.scroll="scroll.cms.toolbar",this.key="keydown.cms.toolbar keyup.cms.toolbar",this.timer=function(){},this.lockToolbar=!1,this.ui.toolbar.data("ready")||this._events();var o=this;setTimeout(function(){o._initialStates()},0),this.ui.toolbar.data("ready",!0)},_setupUI:function(){var i=t(".cms");this.ui={container:i,body:t("html"),document:t(document),window:t(window),toolbar:i.find(".cms-toolbar"),toolbarTrigger:i.find(".cms-toolbar-trigger"),navigations:i.find(".cms-toolbar-item-navigation"),buttons:i.find(".cms-toolbar-item-buttons"),messages:i.find(".cms-messages"),structureBoard:i.find(".cms-structure")}},_events:function(){var o=this,s=10;this.ui.toolbarTrigger.on(this.pointerUp,function(t){t.preventDefault(),o.toggle(),o.ui.document.trigger(o.click)}).on(this.click,function(t){t.preventDefault()}),this.ui.navigations.each(function(){function s(){d=!1,h=!1,n.removeClass(r),n.find("ul ul").hide(),e.find("> li").off(o.mouseEnter),o.ui.document.off(o.click),o.ui.toolbar.off(o.click,s),o.ui.structureBoard.off(o.click),o.ui.window.off(o.resize+".menu.reset"),o._handleLongMenus()}var e=t(this),n=e.find("li"),a="cms-toolbar-item-navigation",r="cms-toolbar-item-navigation-hover",l="cms-toolbar-item-navigation-disabled",c="cms-toolbar-item-navigation-children",u=!1,d=!1,h=!1;e.find("a").on(o.click+" "+o.key,function(i){var e=t(this);return i.keyCode!==CMS.KEYS.CMD_LEFT&&i.keyCode!==CMS.KEYS.CMD_RIGHT&&i.keyCode!==CMS.KEYS.CMD_FIREFOX&&i.keyCode!==CMS.KEYS.SHIFT&&i.keyCode!==CMS.KEYS.CTRL||(h=!0),"keyup"===i.type&&(h=!1),""===e.attr("href")||"#"===e.attr("href")||e.parent().hasClass(l)?void 0:(h?CMS.API.Helpers._getWindow().open(e.attr("href"),"_blank"):o._delegate(t(this)),s(),!1)}).on(o.touchStart,function(){u=!0}),n.on(o.click,function(n){n.preventDefault(),n.stopPropagation();var h=t(this);if(h.parent().hasClass(a)&&d)return o.ui.body.trigger(o.click),!1;h.hasClass(c)||s();var g=h.parent().hasClass(a);return g&&h.hasClass(r)||h.hasClass(l)&&!g?!1:(h.addClass(r),o._handleLongMenus(),u||e.find("> li").on(o.mouseEnter,function(){return t(this).hasClass(r)?!1:(d=!1,void t(this).trigger(o.click))}),u=!1,o.ui.document.on(o.click,s),o.ui.structureBoard.on(o.click,s),o.ui.toolbar.on(o.click,s),o.ui.window.on(o.resize+".menu.reset",CMS.API.Helpers.throttle(s,i)),void(d=!0))}),n.on(o.pointerOverOut,"li",function(){var i=t(this),s=i.closest(".cms-toolbar-item-navigation-children").add(i.parents(".cms-toolbar-item-navigation-children")),e=i.hasClass(c)||s.length;return i.hasClass(l)?!1:i.hasClass(r)?!0:(n.find("li").removeClass(r),i.addClass(r),e?(i.find("> ul").show(),s.addClass(r),o._handleLongMenus()):(n.find("ul ul").hide(),o._handleLongMenus()),void i.siblings().find("> ul").hide())}).on(o.click,function(t){t.preventDefault(),t.stopPropagation()}),n.on(o.pointerLeave,"> ul",function(){n.find("li").removeClass(r)})}),this.ui.buttons.each(function(){var i=t(this);i.find("a").attr("data-rel")?i.on(o.click,function(i){i.preventDefault(),o._delegate(t(this).find("a"))}):i.find("a").on(o.click,function(t){t.stopPropagation()}),i.find(".cms-publish-page").on(o.click,function(t){CMS.API.Helpers.secureConfirm(CMS.config.lang.publish)||t.preventDefault()}),i.find(".cms-btn-publish").on(o.click,function(i){i.preventDefault(),o.showLoader(),t.ajax({type:"post",url:t(this).prop("href"),data:{csrfmiddlewaretoken:CMS.config.csrf},success:function(){var t=CMS.API.Helpers.makeURL(CMS.API.Helpers._getWindow().location.href.split("?")[0],[CMS.settings.edit_off+"=true"]);CMS.API.Helpers.reloadBrowser(t),o.hideLoader()},error:function(t){throw o.hideLoader(),new Error(t)}})})}),this.ui.window.on([this.resize,this.scroll].join(" "),CMS.API.Helpers.throttle(t.proxy(this._handleLongMenus,this),s))},_initialStates:function(){var i=t(".cms-btn-publish").parent();if("expanded"===CMS.settings.toolbar?this.open({duration:0}):this.close(),i.hide(),t(".cms-btn-publish-active").length&&(i.show(),this.ui.window.trigger("resize")),CMS.config.debug&&this._debug(),CMS.config.messages&&CMS.API.Messages.open({message:CMS.config.messages}),CMS.config.error&&CMS.API.Messages.open({message:CMS.config.error,error:!0}),CMS.config.auth&&CMS.config.settings.version===CMS.settings.version||(this.open({duration:0}),CMS.settings=this.setSettings(CMS.config.settings)),CMS.config.publisher&&CMS.API.Messages.open({message:CMS.config.publisher,dir:"right"}),CMS.settings.sideframe&&CMS.settings.sideframe.url){var o=new CMS.Sideframe;o.open({url:CMS.settings.sideframe.url,animate:!1})}this.ui.body.addClass("cms-ready"),this.ui.document.trigger("cms-ready")},toggle:function(){"collapsed"===CMS.settings.toolbar?this.open():this.close()},open:function(t){this._show(t),CMS.settings.toolbar="expanded",CMS.settings=this.setSettings(CMS.settings)},_show:function(i){var s=this,e=i&&void 0!==i.duration?i.duration:this.options.toolbarDuration,n=t(".cms-debug-bar").height()||0,a=t(".cms-toolbar").height()+o;this.ui.toolbar.css({transition:"margin-top "+e+"ms","margin-top":0}),this.ui.toolbarTrigger.addClass("cms-toolbar-trigger-expanded"),this.ui.body.addClass("cms-toolbar-expanding"),this.ui.body.animate({"margin-top":a-o+n},e,"linear",function(){s.ui.body.removeClass("cms-toolbar-expanding"),s.ui.body.addClass("cms-toolbar-expanded")}),this.ui.messages.css("top",a-o)},close:function(){this._hide(),CMS.settings.toolbar="collapsed",CMS.settings=this.setSettings(CMS.settings)},_hide:function(){var i=this.options.toolbarDuration,e=t(".cms-toolbar").height()+o,n=this;return this.ui.toolbar.css("transition","margin-top "+i+"ms"),this.lockToolbar?!1:(this.ui.toolbar.css("margin-top",-e),this.ui.toolbarTrigger.removeClass("cms-toolbar-trigger-expanded"),this.ui.body.addClass("cms-toolbar-collapsing"),this.ui.body.animate({"margin-top":CMS.config.debug?s:0},i,"linear",function(){n.ui.body.removeClass("cms-toolbar-expanded cms-toolbar-collapsing")}),void this.ui.messages.css("top",0))},openAjax:function(i){var o=this,s=i.url,e=i.post||"{}",n=i.text||"",a=i.callback,r=i.onSuccess,l=n?CMS.API.Helpers.secureConfirm(n):!0;return l?(this.showLoader(),t.ajax({type:"POST",url:s,data:JSON.parse(e)}).done(function(t){CMS.API.locked=!1,a?(a(o,t),o.hideLoader()):r?CMS.API.Helpers.reloadBrowser(r,!1,!0):CMS.API.Helpers.reloadBrowser(!1,!1,!0)}).fail(function(t){CMS.API.locked=!1,CMS.API.Messages.open({message:t.responseText+" | "+t.status+" "+t.statusText,error:!0})})):!1},showLoader:function(){this.ui.toolbarTrigger.addClass("cms-toolbar-loader")},hideLoader:function(){this.ui.toolbarTrigger.removeClass("cms-toolbar-loader")},_delegate:function(t){var i=t.data("rel");if(t.hasClass("cms-btn-disabled"))return!1;switch(i){case"modal":var o=new CMS.Modal({onClose:t.data("on-close")});o.open({url:t.attr("href"),title:t.data("name")});break;case"message":CMS.API.Messages.open({message:t.data("text")});break;case"sideframe":var s=new CMS.Sideframe({onClose:t.data("on-close")});s.open({url:t.attr("href"),animate:!0});break;case"ajax":this.openAjax({url:t.attr("href"),post:JSON.stringify(t.data("post")),text:t.data("text"),onSuccess:t.data("on-success")});break;default:CMS.API.Helpers._getWindow().location.href=t.attr("href")}},_lock:function(t){t?(this.lockToolbar=!0,this.ui.toolbarTrigger.css("opacity",.2)):(this.lockToolbar=!1,this.ui.toolbarTrigger.css("opacity",1))},_debug:function(){var t=1e3,i=this.ui.container.find(".cms-debug-bar");i.on(this.mouseEnter+" "+this.mouseLeave,CMS.API.Helpers.debounce(function(t){var i="mouseenter"===t.type||"mouseover"===t.type;i&&CMS.API.Messages.open({message:CMS.config.lang.debug})},t))},_handleLongMenus:function(){var i=t(".cms-toolbar-item-navigation-hover > ul");if(!i.length)return void this._stickToolbar();var o=i.toArray().map(function(i){var o=t(i);return t.extend({},o.position(),{height:o.height()})}),s=this.ui.window.height();this._position.top=this.ui.window.scrollTop();var e=o.some(function(t){return t.top+t.height>s});e&&this._position.top>=this._position.stickyTop?this._position.isSticky&&this._unstickToolbar():this._stickToolbar()},_stickToolbar:function(){this._position.stickyTop=0,this._position.isSticky=!0,this.ui.body.removeClass("cms-toolbar-non-sticky"),this.ui.toolbar.css({top:0})},_unstickToolbar:function(){this._position.stickyTop=this._position.top,this.ui.body.addClass("cms-toolbar-non-sticky"),this.ui.toolbar[0].style.setProperty("top",this._position.stickyTop+(CMS.config.debug?s:-s)+"px","important"),this._position.isSticky=!1}})}(CMS.$);
var CMS=window.CMS||{};!function(i){"use strict";CMS.Tooltip=new CMS.Class({initialize:function(){this.body=i("body"),this.isTouch=!1,this.domElem=this._pick(),this._forceTouchOnce=CMS.API.Helpers.once(this._forceTouch),this._checkTouch()},_checkTouch:function(){this.body.one("touchstart.cms",i.proxy(this._forceTouchOnce,this))},_forceTouch:function(){this.isTouch=!0,this.domElem=this._pick(),this.domElem.on("touchstart.cms",function(){var t=i(this).data("plugin_id"),o=i(".cms-plugin-"+t);if(o.length)o.trigger("dblclick.cms");else{var s=i('.cms-plugin[class*="cms-plugin-cms-"][class*="-'+t+'"]');s.eq(0).trigger("dblclick.cms")}})},displayToggle:function(i,t,o,s){i?this.show(t,o,s):this.hide()},show:function(i,t,o){var s=this.domElem,c=this;s.css("visibility","visible").data("plugin_id",o||null).show().find("span").html(t),this.isTouch?this.position(i.originalEvent,s):(c.position(i.originalEvent,s),this.body.on("mousemove.cms.tooltip",function(i){c.position(i,s)}))},hide:function(){this.domElem.css("visibility","hidden").hide(),this.isTouch||this.body.off("mousemove.cms.tooltip")},_pick:function(){return i(".cms-tooltip-touch, .cms-tooltip").css("visibility","hidden").hide(),i(this.isTouch?".cms-tooltip-touch":".cms-tooltip")},position:function(t,o){var s=20,c=12,h=t.pageX-i(o).offsetParent().offset().left,e=t.pageY-i(o).offsetParent().offset().top,n=i(o).offsetParent().width(),l=h+o.outerWidth(!0)+s;o.css({left:l>=n?h-o.outerWidth(!0)-s:h+s,top:e-c})}})}(CMS.$);